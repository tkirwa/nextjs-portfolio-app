    ...
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 py-10 px-6">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <p className="text-sm md:text-base">
          &copy; {new Date().getFullYear()} Tonny Kirwa. All rights reserved.
        </p>
        ...
        <div className="flex space-x-4">
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/tonny-kirwa-957ba0104/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-blue-500 transition-colors"
            aria-label="LinkedIn"
          ...
          >
            <svg
              ...
              className="w-5 h-5"
            >
              <path d="M2 4v16h20V4H2zm11.91 5.23l1.37 4.15 1.46-4.15h1.7v6h-1.38v-4.83l-1.46 4.83h-1.41l-1.42-4.83V15h-1.38v-6h1.7zM5.5 9h1.38v6H5.5v-6zm14 0h1.38v6H19.5v-6z" />
            </svg>
          </a>

          {/* Email */}
          <a
            href="mailto:tonny@gmail.com"
            className="hover:text-blue-500 transition-colors"
            aria-label="Email"
          >
            <Mail size={20} />
